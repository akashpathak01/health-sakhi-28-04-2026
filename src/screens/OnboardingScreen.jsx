...
const OnboardingScreen = () => {
  ...
  return (
    <div className="min-h-screen lg:h-screen w-full bg-[#FFF7F8] flex flex-col overflow-x-hidden overflow-y-auto lg:overflow-hidden font-sans relative text-[#2D1520]">
                  ...
                  {[
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={`text-[9px] md:text-[11px] font-black uppercase tracking-[0.2em] block ${isSelected ? 'text-[#ff69b4]' : 'text-[#2D1520]'}`}>
                          {item.label}
                        </span>
                      </button>
                    );
        ...
        <section className="hidden lg:flex flex-col items-center justify-center relative p-12 overflow-hidden">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#2D1520]/60 via-transparent to-transparent" />

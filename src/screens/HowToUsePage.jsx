            ...
            <section className="relative py-12 overflow-hidden hero-gradient">
                <div className="w-full px-4 sm:px-[6%] lg:px-[10%] relative z-10 text-center">
                    ...
                    <motion.h1 
                        ...
                        className="text-3xl md:text-5xl font-black text-[#2D1520] mb-6 tracking-tight leading-tight"
                    >
                        Mastering Your <br />
            ...
            <section className="py-16 bg-white">
                <div className="w-full px-4 sm:px-[6%] lg:px-[10%]">
                    <div className="text-center mb-12">
                         <h2 className="text-3xl font-black text-[#2D1520] mb-3 tracking-tight">Simple roadmap</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {steps.map((step, idx) => (
                            ...
                            >
                                ...
                                <h3 className="text-lg font-black text-[#2D1520] mb-2 tracking-[0.01em]">{step.title}</h3>
                ...
                <div className="w-full px-4 sm:px-[6%] lg:px-[10%]">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-8">
                            ...
                            <h2 className="text-4xl sm:text-5xl font-black text-[#2D1520] leading-tight">
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    <div key={i} className="flex gap-4">
                                        ...
                                        <div>
                                            <p className="font-black text-[#2D1520] text-lg">{f.t}</p>
                            ...
                            <div className="absolute -bottom-10 -right-10 bg-white p-8 rounded-[2.5rem] shadow-2xl border border-rose-50 hidden sm:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-black text-[#2D1520]">100% Secure</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="w-full px-4 sm:px-[6%] lg:px-[10%]">
                    <div className="max-w-2xl mx-auto space-y-8">
                        <div className="text-center">
                            <h2 className="text-2xl font-black text-[#2D1520] mb-2 tracking-tight">Quick Answers</h2>
                            ...
                            {faqs.map((faq, idx) => (
                                <details key={idx} className="group bg-[#FFF7F8] rounded-[1.5rem] border border-rose-50 overflow-hidden">
                                    <summary className="p-6 cursor-pointer list-none flex items-center justify-between">
                                        <span className="text-base font-black text-[#2D1520]">{faq.q}</span>

...
const AdvisorConsultations = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8 space-y-8">
      <div>
        <h1 className="text-3xl font-black text-[#2D1520]">Consultation Center</h1>
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-4 bg-white border border-rose-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#ff69b4]/20 font-bold text-[#2D1520]"
            />
          </div>
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-[#2D1520]">{c.user}</h4>
          ...
          <div className="p-8 bg-white border border-rose-100 rounded-[3rem] shadow-sm flex-1 space-y-6">
             ...
             <div className="space-y-4">
               ...
               <textarea 
                  ...
                  className="w-full p-6 bg-rose-50/20 border border-rose-100 rounded-3xl focus:outline-none focus:ring-2 focus:ring-[#ff69b4]/20 transition-all font-bold text-[#2D1520] leading-relaxed"
               ></textarea>

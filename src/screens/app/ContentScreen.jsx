        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
           <div className="flex items-center gap-6">
              <motion.button 
                ...
                className="w-12 h-12 rounded-2xl bg-white border border-rose-100 flex items-center justify-center text-[#2D1520] shadow-sm hover:shadow-md transition-all"
              >
                <ChevronLeft size={20} />
              </motion.button>
              <div>
                <h1 className="text-4xl font-black tracking-tight text-[#2D1520]">Wellness Library</h1>
                ...
                >
                   <div className="flex items-center gap-6">
                      ...
                      <div>
                         ...
                         <h3 className="text-2xl font-black text-[#2D1520] tracking-tight">{module.title}</h3>
                         <p className="text-xs font-medium text-[#9A8A8E] mt-1 max-w-md leading-relaxed">{module.description}</p>
                      </div>
                   </div>
                   <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-500 ${expandedModule === module.id ? 'bg-[#2D1520] text-white rotate-180' : 'bg-rose-50 text-[#C4A0AC]'}`}>
                      <ChevronDown size={20} />
                   </div>
                </button>
                                   ...
                                   {sub.playlists.map((playlist, pIdx) => (
                                     <div key={pIdx} className="bg-white/80 rounded-[2.25rem] p-6 border border-rose-50 shadow-sm hover:shadow-md transition-all group/card">
                                        <div className="flex items-center justify-between mb-6">
                                           <h5 className="text-base font-black text-[#2D1520]">{playlist.title}</h5>
                                            ...
                                            return (
                                              ...
                                              >
                                                 <div className="flex items-center gap-3">
                                                    ...
                                                    <span className={`text-xs font-bold ${isDone ? 'text-[#ff69b4]' : 'text-[#2D1520]'}`}>{video.title}</span>
                                                 </div>
              ...
              <div className="w-full md:w-96 bg-white p-6 md:p-10 flex flex-col justify-between border-l border-rose-50 overflow-y-auto custom-scrollbar">
                 <div className="space-y-6 md:space-y-8">
                    ...
                    <div className="space-y-4">
                       <p className="text-xs font-bold text-[#2D1520] leading-relaxed italic">"Sakhi, understanding this will empower you to take better care of your unique body."</p>

         ...
         >
            <motion.section variants={item} className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
               <div className="space-y-1">
                  <h2 className="text-4xl font-black tracking-tight" style={{ color: '#2D1520' }}>Home Budget Sakhi 🏠</h2>
            ...
            <main className="grid grid-cols-1 lg:grid-cols-12 gap-10">
               <div className="lg:col-span-8 space-y-10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                     <motion.div variants={item} className="p-10 rounded-[3rem] bg-[#2D1520] text-white relative overflow-hidden group shadow-2xl">
                     ...
                     <motion.div variants={item} className="p-10 rounded-[3rem] bg-white border border-[#F5E6EA] shadow-sm flex flex-col justify-between">
                        <div>
                           ...
                           <h3 className="text-3xl font-black tracking-tight" style={{ color: '#2D1520' }}>₹{(stats.totalIncome - stats.totalExpenses).toLocaleString()}</h3>
                        </div>
                                 ...
                                 return (
                                    ...
                                    >
                                       <div className="flex items-center gap-5">
                                          ...
                                          <div>
                                             <h4 className="text-[13px] font-black" style={{ color: '#2D1520' }}>{t.title}</h4>
               ...
               <div className="lg:col-span-4 space-y-10">
                           ...
                           return (
                              <div key={i}>
                                 <div className="flex justify-between text-[11px] font-black mb-1">
                                    ...
                                    <span style={{ color: '#2D1520' }}>₹{spent.toLocaleString()}</span>
                                 </div>
                  ...
                  {/* Tip Card */}
                  <motion.div variants={item} className="p-10 rounded-[3.5rem] bg-gradient-to-br from-[#2D1520] to-[#4A2535] text-white shadow-2xl relative overflow-hidden">
            ...
            {isModalOpen && (
               <div className="fixed inset-0 z-[200] flex items-start justify-center p-4 pt-24 overflow-y-auto no-scrollbar">
                  <motion.div
                     ...
                     className="absolute inset-0 bg-[#2D1520]/60 backdrop-blur-md"
                  />
                  <motion.div
                     ...
                     <div className="p-8 md:p-12">
                        <div className="flex items-center justify-between mb-10">
                           <div className="flex items-center gap-4">
                              ...
                              <h3 className="text-2xl font-black" style={{ color: '#2D1520' }}>{editingId ? 'Update Transaction' : 'Log with Sakhi'}</h3>
                           </div>
                           <button 
                              onClick={() => {
                                 setIsModalOpen(false);
                        ...
                        <form onSubmit={handleAddTransaction} className="space-y-8">
                           ...
                           <div className="space-y-3">
                              ...
                              <div className="relative">
                                 <div className="absolute left-6 top-1/2 -translate-y-1/2 text-2xl font-black text-[#2D1520]">₹</div>
                                 <input 
                                    autoFocus
                                    type="number" 
                                    value={amount}
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                 {currentCategories.map((cat) => (
                                    ...
                                    >
                                       ...
                                       <span className="text-[10px] font-black uppercase tracking-widest text-[#2D1520]">{cat.label}</span>
                                    </button>
                                 ))}
                              </div>
                           </div>
                     ...
                     <div className="p-10 md:p-14">
                        <div className="flex items-center justify-between mb-12">
                           <div>
                              ...
                              <h3 className="text-3xl font-black" style={{ color: '#2D1520' }}>Monthly Report</h3>
                           </div>
                           <button 
                              onClick={() => setIsReportOpen(false)}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                           <div className="p-8 rounded-[2.5rem] bg-[#FDEEF1] border border-white/50">
                              ...
                              <h4 className="text-4xl font-black mb-2" style={{ color: '#2D1520' }}>₹{(stats.totalIncome - stats.totalExpenses).toLocaleString()}</h4>
                           ...
                           <div className="p-8 rounded-[2.5rem] bg-[#F5F1FE] border border-white/50">
                              ...
                              <h4 className="text-4xl font-black mb-2" style={{ color: '#2D1520' }}>₹{stats.totalExpenses.toLocaleString()}</h4>
                                    ...
                                    <div key={cat.id} className="flex items-center gap-6">
                                       ...
                                       <div className="flex-1">
                                          <div className="flex justify-between text-xs font-black mb-2">
                                             <span style={{ color: '#2D1520' }}>{cat.label}</span>
                        ...
                        <div className="p-10 rounded-[3rem] bg-[#2D1520] text-white relative overflow-hidden">
                     ...
                     <div className="p-10 md:p-14">
                        <div className="flex items-center justify-between mb-10">
                           <div>
                              ...
                              <h3 className="text-3xl font-black" style={{ color: '#2D1520' }}>Sakhi's Budget Tips</h3>
                           </div>
                           <button 
                              onClick={() => setIsTipsOpen(false)}
                              className="w-12 h-12 rounded-full border border-[#F5E6EA] flex items-center justify-center text-[#C4A0AC] hover:bg-[#FDEEF1] hover:text-[#ff69b4] transition-all"
                        ...
                        <div className="space-y-6">
                           {budgetTips.map((tip) => (
                              ...
                              >
                                 ...
                                 <div>
                                    <h4 className="text-sm font-black mb-1" style={{ color: '#2D1520' }}>{tip.title}</h4>
                        ...
                        <button 
                           onClick={() => setIsTipsOpen(false)}
                           className="w-full py-6 bg-[#2D1520] text-white rounded-[2rem] text-xs font-black uppercase tracking-[0.3em] shadow-2xl mt-10 hover:brightness-110 transition-all"
                        >
                           Got it, Sakhi! 💖
                        </button>
                     </div>

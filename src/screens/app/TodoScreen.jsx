    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div className="space-y-1">
          <h2 className="text-4xl font-black tracking-tight" style={{ color: '#2D1520' }}>To-Do Sakhi ✅</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          >
            <div className="flex items-center gap-4 px-4">
                <input
                 ...
                 className="flex-1 py-4 text-sm font-black text-[#2D1520] placeholder:text-[#C4A0AC] outline-none"
               />
              {!isExpanding ? (
                 <button 
                  type="button" 
                ...
                >
                  <div className="grid grid-cols-2 gap-6">
                           ...
                           {['Low', 'Medium', 'High'].map(p => (
                             <button
                               ...
                               className={`flex-1 py-3.5 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all ${
                                 taskPriority === p 
                                 ? 'bg-[#2D1520] text-white shadow-lg scale-105' 
                     ...
                     <div className="space-y-3">
                        ...
                        <select 
                          ...
                          className="w-full bg-slate-50 border border-transparent rounded-xl p-3 text-[10px] font-black uppercase text-[#2D1520] outline-none appearance-none cursor-pointer"
                        >
                  ...
                  <div className="grid grid-cols-2 gap-6">
                     <div className="space-y-3">
                        ...
                        <input 
                          ...
                          className="w-full bg-slate-50 border border-transparent rounded-xl p-3.5 text-[11px] font-bold text-[#2D1520]" 
                        />
                     </div>
                     <div className="space-y-3">
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-slate-50 border border-transparent rounded-2xl p-4 text-xs font-medium text-[#2D1520] min-h-[100px] outline-none focus:bg-white focus:border-rose-100 transition-all"
                    />
                  </div>
                   ...
                   <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                         <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                            <h4 className={`text-base font-black transition-all ${task.completed ? 'text-[#C4A0AC] line-through' : 'text-[#2D1520]'}`}>{task.text}</h4>
                         ...
                         {task.desc && (
                            <div className="relative mb-6">
                               ...
                               <p className="text-xs font-medium text-[#2D1520]/60 leading-relaxed pl-5 italic">"{task.desc}"</p>
                            </div>
                         )}
                         <div className="flex items-center gap-6">
                            <div className="flex items-center gap-2">
                               <div className="w-1.5 h-1.5 rounded-full" style={{ background: categoryColors[task.category]?.color || '#ff69b4' }} />
                               <span className="text-[10px] font-black uppercase tracking-widest" style={{ color: categoryColors[task.category]?.color || '#2D1520' }}>{task.category}</span>
                            </div>
                            <div className="flex items-center gap-2">
        ...
        <div className="md:col-span-4 space-y-10">
          ...
          <div className="bg-white rounded-[3.5rem] p-10 text-[#2D1520] relative overflow-hidden shadow-2xl border border-[#F5E6EA]">
              ...
              {[
                ...
                <div key={i} className="flex items-center justify-between">
                   <div className="flex items-center gap-4">
                      ...
                      <span className="text-[11px] font-black uppercase tracking-widest text-[#2D1520]">{item.label}</span>
                   </div>

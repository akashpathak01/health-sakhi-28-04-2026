...
const SubscriptionPlansScreen = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-2 lg:px-0 mt-4 pb-20">
      <div className="mb-8">
        <h1 className="text-3xl font-black tracking-tight text-[#2D1520]">Subscription & Billing</h1>
      ...
      <div className="mt-10 rounded-[2rem] bg-white border border-[#F5E6EA] p-6 flex items-center gap-4">
        ...
        <div>
          <p className="text-sm font-black text-[#2D1520]">Auto-billing simulation active</p>

      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-1">
        <div className="space-y-1">
          <button 
            ...
            className="flex items-center gap-2 text-slate-400 hover:text-health-green transition-colors font-black text-[10px] uppercase tracking-widest mb-2"
          >
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full h-14 px-6 bg-slate-50 border border-transparent rounded-2xl outline-none focus:bg-white focus:border-health-green transition-all font-bold text-sm text-slate-800"
              />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <select 
                ...
                className="w-full h-14 px-6 bg-slate-50 border border-transparent rounded-2xl outline-none focus:bg-white focus:border-health-green transition-all font-bold text-sm text-slate-800 appearance-none cursor-pointer"
              >
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <textarea 
                ...
                className="w-full h-32 p-6 bg-slate-50 border border-transparent rounded-[2rem] outline-none focus:bg-white focus:border-health-green transition-all font-medium text-sm text-slate-600 resize-none"
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[2.5rem] border border-black/5 p-8 sm:p-10 shadow-sm space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative h-14 bg-slate-50 border border-dashed border-slate-300 rounded-2xl flex items-center px-6 group hover:border-health-green transition-all cursor-pointer">
                ...
                <div className="flex items-center gap-3 text-slate-400 group-hover:text-health-green">
                  <UploadCloud size={18} />
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <div className="relative h-32 bg-slate-50 border border-dashed border-slate-300 rounded-[2rem] flex flex-col items-center justify-center group hover:border-health-green transition-all cursor-pointer">
                ...
                <UploadCloud size={32} className="text-slate-300 group-hover:text-health-green mb-2" />
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest group-hover:text-health-green transition-colors">
        ...
        <div className="bg-white rounded-[2.5rem] border border-black/5 p-8 sm:p-10 shadow-sm space-y-8">
          <div className="flex items-center justify-between mb-2">
            ...
            <button type="button" onClick={addQuestion} className="h-10 px-4 bg-health-green text-white font-black text-[9px] uppercase tracking-widest rounded-xl flex items-center gap-2 hover:scale-105 active:scale-95 transition-all">
              ...
              <div key={qIdx} className="p-6 sm:p-8 bg-slate-50 rounded-[2rem] border border-black/5 space-y-6 relative animate-in zoom-in-95 duration-300">
                ...
                <div className="space-y-2 pr-10">
                  ...
                  <input 
                    ...
                    className="w-full h-14 px-6 bg-white border border-black/5 rounded-2xl outline-none focus:border-health-green transition-all font-bold text-sm text-slate-800"
                  />
                </div>
                  ...
                  {q.options.map((opt, oIdx) => (
                    <div key={oIdx} className="space-y-1">
                      ...
                      <input 
                        ...
                        className="w-full h-12 px-4 bg-white border border-black/5 rounded-xl outline-none focus:border-health-green transition-all font-bold text-xs text-slate-700"
                      />
                    </div>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                  <div className="space-y-2">
                    ...
                    <select 
                      ...
                      className="w-full h-14 px-6 bg-white border border-black/5 rounded-2xl outline-none focus:border-health-green transition-all font-bold text-sm text-slate-800 cursor-pointer appearance-none"
                    >
        ...
        <div className="sticky bottom-8 z-40 bg-white/80 backdrop-blur-md border border-black/5 rounded-3xl p-4 sm:p-6 shadow-2xl flex items-center justify-between gap-4">
           ...
           <div className="flex gap-3">
              ...
              <button type="submit" className="px-10 py-4 bg-health-green text-white font-black text-[10px] uppercase tracking-widest rounded-2xl flex items-center gap-2 hover:scale-105 active:scale-95 transition-all shadow-xl shadow-health-green/40">
